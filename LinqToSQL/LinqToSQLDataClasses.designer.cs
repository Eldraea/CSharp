...
namespace LinqToSQL
{
    ...
    partial void DeleteStudentLecture(StudentLecture instance);
		...
		public LinqToSQLDataClassesDataContext() : 
				base(global::LinqToSQL.Properties.Settings.Default.MyDatabaseConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class StudentLecture : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _LectureId;
    ...
    partial void OnLectureIdChanging(System.Nullable<int> value);
    partial void OnLectureIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LectureId", DbType="Int")]
		public System.Nullable<int> LectureId
		{
			get
			{
		...
		public Lecture Lecture
		{
			...
			set
			{
							...
							|| (this._Lecture.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._LectureId = default(Nullable<int>);
					}
